    ...
    <div className="max-w-7xl mx-auto px-4 py-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {filtered.map((project, idx) => (
          <div key={idx} className="rounded-2xl shadow-xl p-6 bg-blue-100 text-blue-900 hover:scale-105 hover:shadow-2xl transition-all duration-300 group">
            <div className="font-extrabold text-2xl mb-2 flex items-center gap-2">
              🏗️ <span className="drop-shadow-lg">{project.client}</span>
            </div>
            <div className="flex items-center text-blue-700 mb-1"><span className="mr-2">📍</span> <span>{project.location}</span></div>
            <div className="flex items-center text-blue-700 mb-1"><span className="mr-2">🏢</span> <span>{project.description}</span></div>
            <div className="flex items-center text-blue-700 mb-2"><span className="mr-2">💰</span> <span>{project.value}</span></div>
            ...
            <button
              className="mt-4 text-blue-900 underline text-xs font-semibold opacity-80 hover:opacity-100 cursor-pointer"
