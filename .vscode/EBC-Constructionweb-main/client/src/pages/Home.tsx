          ...
          <div className="container mx-auto px-4">
            <div className="max-w-7xl mx-auto">
              ...
              <div className="flex flex-wrap justify-center gap-2 sm:gap-4 mb-10 px-2">
                <button onClick={() => setTab('government')} className={`min-w-[150px] w-full sm:w-auto px-4 sm:px-6 py-2 rounded-full font-semibold border transition-all duration-200 focus:outline-none ${tab==='government' ? 'bg-primary text-white shadow-lg' : 'bg-white text-primary border-primary hover:bg-blue-50'}`}>Government Clients</button>
                <button onClick={() => setTab('psu')} className={`min-w-[150px] w-full sm:w-auto px-4 sm:px-6 py-2 rounded-full font-semibold border transition-all duration-200 focus:outline-none ${tab==='psu' ? 'bg-primary text-white shadow-lg' : 'bg-white text-primary border-primary hover:bg-blue-50'}`}>PSU Clients</button>
                <button onClick={() => setTab('private')} className={`min-w-[170px] w-full sm:w-auto px-4 sm:px-6 py-2 rounded-full font-semibold border transition-all duration-200 focus:outline-none ${tab==='private' ? 'bg-primary text-white shadow-lg' : 'bg-white text-primary border-primary hover:bg-blue-50'}`}>Private & NGO Clients</button>
              </div>
