...
export default function Investors() {
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        <title>Investor Relations - Ramsethu Construction </title>
        <meta name="description" content="Access Ramsethu Construction's financial reports, annual reports, shareholding information, and investor resources." />
      </Helmet>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div>
                    ...
                    <div className="space-y-2 text-gray-600">
                      ...
                      <p><strong>Address:</strong> Ramsethu Construction House, Madhapur, Hyderabad - 500081</p>
                    </div>
                  </div>
                  <div>
